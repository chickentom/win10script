...
$Form.ClientSize                 = New-Object System.Drawing.Point(1250,700)
$Form.text                       = "Form"
$Form.TopMost                    = $false
...
$Panel1.controls.AddRange(@($installchoco,$brave,$firefox,$7zip,$irfanview,$adobereader,$notepad,$gchrome,$mpc,$vlc,$powertoys,$winterminal,$vscode,$test,$Label2))
